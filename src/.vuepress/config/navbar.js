module.exports = {
  zh: [
      ...
      items: [
        { text: "快速导航", link: "", icon: "quick" },
        {
          ...
          items: [
            ...
            { text: "Java", link: "language/java/", icon: "java" },
            { text: "Python", link: "language/python/", icon: "python",},
          ],
        },
        // {
        //   text: "前端",
    ...
    // },
    {
      ...
      icon:'subject',
      items: [
        { text: "算法", link: "https://small-universe.github.io/QiQi-Algorithm/", icon: "algorithm" },
